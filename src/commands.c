...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/06 12:38:15 by masmar            #+#    #+#             */
/*   Updated: 2024/08/06 12:38:17 by masmar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/push_swap.h"

// (RRA/RRB) Moves bottom element to the top
...
// (SA/SB) Swaps the first two elements at the top of the stack
...
// (RA/RB) Moves the top element to the bottom
